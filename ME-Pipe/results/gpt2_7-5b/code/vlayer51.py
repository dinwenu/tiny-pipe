import torch
from gpt2_huggingface.modeling2_gpt2 import GPT2LayerNorm
from gpt2_huggingface.modeling_utils import Conv1D

class vLayer51(torch.nn.Module):
    def __init__(self, config):
        super(vLayer51, self).__init__()
        self.layer1 = GPT2LayerNorm(config=config)
        self.config = config
