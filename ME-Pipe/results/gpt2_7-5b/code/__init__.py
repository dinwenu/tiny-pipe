...
from .vlayer51 import vLayer51
from .vlayer52 import vLayer52
...
def model(config, criterion):
    ...
    vlayer51 = vLayer51(config)
    vlayer52 = vLayer52(config)
    ...
    return [
        ...
        (vlayer51, ["out50"], ["out51"]),
        (vlayer52, ["out51"], ["out52"]),
        (criterion, ["out52"], ["loss"])
    ]
